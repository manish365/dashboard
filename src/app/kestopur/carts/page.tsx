    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <KpSelect value={statusFilter} onChange={setStatusFilter}>
          <option value="" className="theme-option">All Carts</option>
          <option value="active" className="theme-option">Active</option>
          <option value="abandoned" className="theme-option">Abandoned</option>
        </KpSelect>
      </div>
