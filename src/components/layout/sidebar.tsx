...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-16 z-50 h-[calc(100vh-4rem)] w-60 border-r border-white/10 backdrop-blur-xl transition-transform duration-300 lg:relative lg:top-0 lg:z-0 lg:translate-x-0 ${state.sidebarOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
